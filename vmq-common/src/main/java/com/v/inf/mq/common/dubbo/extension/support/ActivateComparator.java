 ...
 */
package com.v.inf.mq.common.dubbo.extension.support;

import com.v.inf.mq.common.dubbo.extension.Activate;
...
public class ActivateComparator implements Comparator<Object> {
    ...
    public int compare(Object o1, Object o2) {
        ...
        String[] a1Before = new String[0], a2Before = new String[0], a1After = new String[0], a2After = new String[0];
        int a1Order = 0, a2Order = 0;
        Class<?> inf = null;
